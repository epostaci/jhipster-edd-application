...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fmss.edd.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fmss.edd.security.DomainUserDetailsService", "createSpringSecurityUser");
