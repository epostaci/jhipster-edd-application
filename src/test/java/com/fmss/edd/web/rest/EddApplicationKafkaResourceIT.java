...
import com.fmss.edd.config.EmbeddedKafka;
...
@WithMockUser
@EmbeddedKafka
class EddApplicationKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/edd-application-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/edd-application-kafka/consume")
