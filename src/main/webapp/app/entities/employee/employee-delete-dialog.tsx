...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eddApplicationApp.employee.delete.question">
        <Translate contentKey="eddApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
