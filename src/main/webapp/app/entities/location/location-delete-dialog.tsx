...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eddApplicationApp.location.delete.question">
        <Translate contentKey="eddApplicationApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
