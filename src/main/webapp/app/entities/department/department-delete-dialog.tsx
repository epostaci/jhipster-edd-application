...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eddApplicationApp.department.delete.question">
        <Translate contentKey="eddApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
