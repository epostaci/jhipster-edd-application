...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eddApplicationApp.jobHistory.delete.question">
        <Translate contentKey="eddApplicationApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
